...
function HowItWorks({ onBook }) {
  const steps = [
    ...
    },
    {
      ...
      body: 'Im Anschluss erhalten Sie einen ärztlichen Bericht und ggf. nach ärztlichem Ermessen ein Rezept. Ebenfalls erhalten Sie die Rechnung nach Gebührenordnung für Ärzte.'
    },
  ];
